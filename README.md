...
- DOM is a framework that a browser uses to manage the structure of a webpage.
- It converts the whole webpage into a tree like strucutre of HTML elements, where each element is considered as a node.
- A DOM node of a webpage can be nested in another node.

### What is a document?

- A document is a global Object which contains all the DOM elements, and required properties and methods to manage those elements.

## JavaScript Selectors relating to DOM management

- document.querySelector(css_selector) - returns the first instance of an element that has the specific selector.
- document.querySelectorAll(css_selector) - returns all the instances of the elements that have the specific selector.
- document.getElementById(id_selector) - returns the first instance of an element that has the specific Id.
- document.getElementsByClassName(class_selector) - returns all the instances of the elements in the form of an HTML collection, that have the specific class attribute.
- document.getElementsByTagName(tag_selector) - returns all the instances of the elements in the form of an HTML collection, that have the specific HTML tag name.
